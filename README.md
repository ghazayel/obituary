...
> **نصيحة للمساهمين**: أضف لقطات شاشة للواجهة على سطح المكتب والجوال في مجلد `screenshots/` أو داخل الـ README.

(يمكنك إضافة صور هنا بعد التقاطها من المعاينة الحية)

---

## 🌍 النشر على GitHub Pages

المشروع جاهز للنشر كموقع ثابت:

1. ادفع التغييرات إلى فرع `main`
2. في إعدادات المستودع → **Pages** → اختر مصدر `Deploy from a branch` → `main` → `/ (root)`
3. انتظر دقائق قليلة ثم زر الرابط المُولَّد

> **ملاحظة حالية**: قد يظهر خطأ تحميل في النسخة المباشرة حالياً. تأكد من أن `index.html` موجود في جذر الفرع المنشور.

---

## 📜 الترخيص

هذا المشروع حالياً **غير مرخص** (Unlicensed).  
يُرجى التواصل مع المطور إذا أردت استخدامه أو تعديله في مشاريع أخرى.
